  ...
  return (
    <div id="panel-methodology" role="tabpanel" aria-labelledby="tab-methodology" className="tab-panel methodology-panel">
      ...
      <div className="methodology-grid">
        <section><h4>Journal set</h4><p>OpenAlex articles and reviews are filtered by <code>primary_topic.subfield.id</code> and grouped by journal Source. The 200 Sources with the most matching works form the bounded journal set. Sources must be journals with an ISSN.</p></section>
